...
Polygon triangulation is a process where you divide a polygon into a set of triangles and the vertices of each triangle must 
also be vertices of the original polygon. Note that no other shapes other than triangles are allowed in the division. 
...
class Min{
	...
	public static void main(String[] args){
		...
		int[] values = {1,2,3};
		System.out.print(minScoreTriangulation(values));
