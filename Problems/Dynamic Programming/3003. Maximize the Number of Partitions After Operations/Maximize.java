...
Delete the prefix from s and increase the number of partitions by one. The remaining characters (if any) in s maintain their 
initial order.
Return an integer denoting the maximum number of resulting partitions after the operations by optimally choosing at most one index 
to change. 
...
class Maximize{
	...
	public static void main(String[] args){
		...
		String s = "accca";
		int k = 2;
		System.out.print(obj.maxPartitionsAfterOperations(s, k));
