...
that each child gets the same number of candies. Each child can be allocated candies from only one 
...
class MaxCandies{
	...
	static int minimumCandies(int[] candies, long k){
	...
	public static void main(String[] args){
		int[] candies = {5,8,6};
		long k = 3;
		System.out.println(minimumCandies(candies, k));
	}
}