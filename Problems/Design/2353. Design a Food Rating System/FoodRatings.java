...
class FoodRatings{
	...
	private Map<String, TreeSet<FoodEntry>> cuisineToFood = new HashMap<>();
	...
	public void changeRating(String food, int newRating){
		...
		TreeSet<FoodEntry> foodSet = cuisineToFood.get(cuisine);
		// remove old entry
		foodSet.remove(new FoodEntry(food, foodToRating.get(food)));
		// update rating
		foodToRating.put(food, newRating);
		// add new Entry
		foodSet.add(new FoodEntry(food, newRating));
