...
is the new position of the jth element. If i < j and both elements are smaller (or larger) than 
pivot, then pi < pj.
...
class Partition{
    static void findPivotArray(int[] nums, int pivot){
